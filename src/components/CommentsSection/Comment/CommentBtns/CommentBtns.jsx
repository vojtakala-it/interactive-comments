...
export default function CommentBtns({ score, activeUser, onDeleteComment, onEditComment }) {
    ...
    return (
            <div className='comments__comment__btns'>
                { isMobile && <LikesCounter score={ score }/> }
                { activeUser ?
                        <div className='comments__comment__btns__action'>
                            <button
                                    onClick={ () => onDeleteComment() }
                                    className='btn btn--transparent f-red'>
                                <img
                                        className='comments__comment__btns__action--delete'
                                        src={ deleteIcon }
                            ...
                            <button
                                ...
                                <img
                                        className='comments__comment__btns__action--edit'
                                        src={ editIcon }
                        ...
                        <button className='btn btn--transparent f-blue'>
                            <img
                                    className='comments__comment__btns__action--reply'
                                    src={ replyIcon }
